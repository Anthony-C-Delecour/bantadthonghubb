...
export function MobileHeader({
  ...
  return (
    <>
      <header className="sticky top-0 z-50 h-14 w-full border-b border-border bg-background/80 backdrop-blur-sm flex items-center justify-between px-4 shrink-0">
